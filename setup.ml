...
(* OASIS_START *)
(* DO NOT EDIT (digest: 070d7ba63ea3a5a7b9f6f7593fcaa0a6) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "spotify-web";
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "1mn\028\143\247\142\014^8\238\154\028\225)\016";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
